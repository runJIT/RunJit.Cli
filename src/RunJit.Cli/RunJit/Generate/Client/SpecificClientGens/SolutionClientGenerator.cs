...
{
    internal static class AddSolutionClientGeneratorExtension
    {
        internal static void AddSolutionClientGenerator(this IServiceCollection services)
        {
            ...
            services.AddSingletonIfNotExists<ISpecificClientGenerator, SolutionClientGenerator>();
        }
    }

    internal class SolutionClientGenerator(ControllerParser controllerParser,
                                           ...
                                           HttpCallHandlerFactory httpCallHandlerFactory) : ISpecificClientGenerator
    {
        public bool CanHandle(RunJit.Generate.Client.Client client)
        {
            return client.UseOpenApiJson.IsFalse();
        }
