...
namespace $ProjectName$.Test.Api.$DomainNamePlural$.V1
{
    ...
    [TestCategory("$DomainNamePlural$ V1 Create Status 403 Forbidden")]
    public class Create_Status_403_Forbidden_Test : ApiTestBase
    {
        ...
        public Task Should_Be_Able_To_Create_A_$DomainName$_If_Query_Parameters_Are_Used_Which_Are_Not_Declared(string queryParams,
                                                                                                                      string response)
        {
            return Client.AssertPostAsErrorAsync<ProblemDetails>($"$BasePath$/v1/$DomainNamePluralLower$?{queryParams}",
                                                                 "UseCase_01.json",
                                                                 response,
