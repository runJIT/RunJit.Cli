...
namespace $ProjectName$.Test.Api.$DomainNamePlural$.V1
{
    ...
    [TestCategory("$DomainNamePlural$ V1 DeleteAll Status 403 Forbidden")]
    public class DeleteAll_Status_403_Forbidden_Test : ApiTestBase
    {
                                                                                           ...
                                                                                           string response)
        {
            ...
            return Client.AssertDeleteAsErrorAsync<ProblemDetails>($"$BasePath$/v1/$DomainNamePluralLower$?{queryParams}",
                                                                  response,
