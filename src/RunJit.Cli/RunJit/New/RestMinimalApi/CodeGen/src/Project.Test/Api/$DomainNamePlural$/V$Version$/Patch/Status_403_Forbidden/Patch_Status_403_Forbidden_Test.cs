...
namespace $ProjectName$.Test.Api.$DomainNamePlural$.V1
{
    ...
    [TestCategory("$DomainNamePlural$ V1 Patch Status 403 Forbidden")]
    public class Patch_Status_403_Forbidden_Test : ApiTestBase
    {
        ...
        public Task Should_Be_Able_To_Patch_A_$DomainName$_If_Query_Parameters_Are_Used_Which_Are_Not_Declared(string queryParams,
                                                                                                                      string response)
        {
            return Client.AssertPatchAsErrorAsync<ProblemDetails>($"$BasePath$/v1/$DomainNamePluralLower$/1{queryParams}",
                                                                 "UseCase_01.json",
                                                                 response,
