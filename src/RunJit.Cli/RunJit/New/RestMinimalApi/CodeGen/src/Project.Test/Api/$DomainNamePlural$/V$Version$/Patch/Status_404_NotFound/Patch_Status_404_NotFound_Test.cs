...
namespace $ProjectName$.Test.Api.$DomainNamePlural$.V1
{
    ...
    [TestCategory("$DomainNamePlural$ V1 Patch Status 404 BadRequest")]
    public class Patch_Status_404_NotFound_Test : ApiTestBase
    {
                                                                                              ...
                                                                                              string response)
        {
            ...
            await Client.AssertGetAsErrorAsync<ProblemDetails>($"$BasePath$/v1/$DomainNamePluralLower$/{id}",
