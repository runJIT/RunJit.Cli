...
namespace $ProjectName$.Test.Api.$DomainNamePlural$.V$Version$
{
    ...
    public class Update_$DomainName$_Test : ApiTestBase
    {
        ...
        {
            return Client.AssertPutAsUnauthorizedAsync($"api/core/v$Version$/$DomainNamePluralLower$/not-a-guid");
        }

        [TestMethod]
        public Task Should_Not_Be_Able_To_Put_If_$IdPropertyName$_Is_Not_A_Guid()
        {
            return Client.AssertPutAsync<ProblemDetails>("api/core/v$Version$/$DomainNamePluralLower$/not-a-guid",
        ...
        {
            return Client.AssertPutAsErrorAsync<ValidationProblemDetails>("api/core/v$Version$/$DomainNamePluralLower$/",
                                                                            request,
                                                                            response);
        ...
        public async Task Should_Be_Able_To_Update_A_$DomainName$_With_Valid_Data()
        {
            ...
            await Client.AssertPutAsync<Update$DomainName$Response>($"api/core/v$Version$/$DomainNamePluralLower$/{create$DomainName$Response.$DomainName$.$IdPropertyName$}",
