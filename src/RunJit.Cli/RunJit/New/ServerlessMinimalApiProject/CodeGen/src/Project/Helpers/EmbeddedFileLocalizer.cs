...
namespace $ProjectName$.Helpers
{
    ...
    /// <summary>
    ///     Provides functionality to localize documentation files embedded in assemblies.
    /// </summary>
    internal sealed class EmbeddedFileLocalizer
    {
        /// <summary>
        ///     Localizes the documentation file based on the caller's file path and the calling assembly.
        /// </summary>
